...
enum EParams
{
  ...
  kParamWavetable1Amp,
  kParamWavetable1XMod,
  kParamWavetable2Pitch,
  kParamWavetable2Pos,
  kParamWavetable2Bend,
  kParamWavetable2Amp,
  kParamWavetable2SXMod,
  ...
  kParamOscModulator, // Phase and Ring Modualtion
  kParamOsc1PhaseModSource,
  kParamOsc2PhaseModSource,
  kParamOsc1RingModSource,
  kParamOsc2RingModSource,
  kParamOsc1PM,
  kParamOsc2PM,
  kParamOsc1RM,
  kParamOsc2RM,
  kParamOsc1PhaseModFreq,
  kParamOsc2PhaseModFreq,
  kParamOsc1PhaseModAmount,
  kParamOsc2PhaseModAmount,
  kParamOsc1RingModFreq,
  kParamOsc2RingModFreq,
  kParamOsc1RingModAmount,
  kParamOsc2RingModAmount,
  kParamVoiceEffect1Param1, // Effects
...
enum EControlTags
{
  ...
  kCtrlTagFilter2Osc1,
  kCtrlTagFilter2Osc2,
  kCtrlTagOscModTypeSelector,
  kCtrlTagOscModTargetSelector,
  kCtrlTagOscModSource,
  kCtrlTagOscModFreq,
  kCtrlTagOscModAmt,
  kCtrlTagOscModSwitch,
  kCtrlTagLFO1Plot,
  kCtrlTagLFO2Plot,
  kCtrlTagSequencer,
  kCtrlTagEffectBank,
