...
protected:
  ...
  int mMaxVoices; // TODO: Replace the hardcoded number in the ConditionalVariable wait statement with this variable. Would also be a good idea to make a Tablitsa2VoiceAllocator derived class.
