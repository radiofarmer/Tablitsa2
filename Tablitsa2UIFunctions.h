...
#define TABLITSA2_MAX_EFFECT_DELAY_MS 5000.
#define TABLITSA2_EFFECT_PARAMS 6

#define TABLITSA2_DISTORTION_FREQ_LOW (double)0.01
#define TABLITSA2_DISTORTION_FREQ_HIGH (double)0.25

#define TABLITSA2_SAH_MIN_MS 0.05
#define TABLITSA2_SAH_MAX_MS 10.
