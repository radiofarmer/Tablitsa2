...
def main():
  ...
  plistpath = scriptpath + "/resources/Tablitsa2-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa2-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa2-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa2-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tablitsa2-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Tablitsa2.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Tablitsa2.iss",inplace=1):
