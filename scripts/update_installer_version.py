...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Tablitsa2 Demo Installer\n"
      else:
        line="OutputBaseFilename=Tablitsa2 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Tablitsa2 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Tablitsa2 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Tablitsa2 Demo installer\n"
     else:
       line="SetupWindowTitle=Tablitsa2 installer\n"
